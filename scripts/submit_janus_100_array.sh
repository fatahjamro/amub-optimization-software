#!/usr/bin/env bash
#SBATCH --job-name=amub-jan-128-arr
...
#SBATCH --array=0-9
#SBATCH --output=results/amub_janus_128_arr_%A_%a.log
#SBATCH --error=results/amub_janus_128_arr_%A_%a.err
...
echo "================================================================="
echo "Starting AMUB 10-Seed complex128 Campaign (Array Task $SLURM_ARRAY_TASK_ID) on JANUS"
...
echo "Executing complex128 campaign runner for seeds $SEEDS..."
python3 scripts/run_multiseed_campaign.py --config configs/multiseed_janus_100.yaml --seeds $SEEDS
