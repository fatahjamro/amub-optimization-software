...
\url{https://github.com/fatahjamro/amub-optimization-software} and archived on Zenodo at \url{https://doi.org/10.5281/zenodo.20689038}.
...
This work was supported by Atlantic Technological University, Ireland, under the Postgraduate Research Training Programme in Modelling and Computation for Health and Society (MOCHAS-PRTP). We acknowledge the ATU JANUS High-Performance Computing (HPC) cluster facility for providing computational resources used in the multi-seed campaigns and hardware benchmarks. We thank \href{https://pure.atu.ie/en/persons/michael-mccann-3/}{Dr. Michael McCann}, Director of the JANUS Research Centre, for facilitating access to the JANUS HPC resources.
