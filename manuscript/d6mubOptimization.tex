...
\begin{document}
\title{A Reproducible Precision-Aware Workflow for Unanchored Approximate Mutually Unbiased Bases in Dimension Six}
\author{Abdul Fatah}
...
\item \textbf{Unanchored AMUB formulation:}
...
\item \textbf{Unitary-preserving parameterization:}
...
\item \textbf{Portable hardware-accelerated Taylor exponentiation:}
...
\item \textbf{Multi-seed analysis of a nonconvex landscape:}
...
\item \textbf{Precision-aware analysis:}
...
\item \textbf{Multi-dimensional benchmarks and performance crossover:}
...
\item \textbf{Compact structural diagnostics and visualization:}
...
\graphicspath{{../marimo/results_d6_amub_precision_campaign/heatmap_figures_representative_runs/}}
\begin{figure}[ht]
  \centering
